...
const RegisterPage = () => {
    ...
    const handleSubmitRegister = (e) => {
        e.preventDefault()
        fetch(`https://64f2052d0e1e60602d24967d.mockapi.io/students?email=${email}`)
                ...
                <div className="row text-white">
                    <div className="col-lg-6 d-flex flex-column  justify-content-center  " style={{minHeight: "80vh"}}>
                        ...
                        <form onSubmit={handleSubmitRegister}>
                            ...
                            <div className="mb-3">
                                <label htmlFor="nim-register" className="form-label">NIM</label>
                                <input value={nim} onChange={e => setNim(e.target.value)} type="text" className="form-control" id="nim-register" aria-describedby="emailHelp" placeholder="Silahkan masukkan NIM anda"  />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="kelas-register" className="form-label">Kelas</label>
                                <input value={kelas} onChange={e => setKelas(e.target.value)} type="text" className="form-control" id="kelas-register" aria-describedby="emailHelp" placeholder="Silahkan masukkan Kelas anda"  />
                            </div>
                            <div className="mb-3">
